...
{
    public static RouteGroupBuilder MapSystemConfigurationEndpoints(this RouteGroupBuilder adminGroup)
    {
        // ✅ Use the admin group that already has auth + SuperAdmin validation
        var group = adminGroup.MapGroup("/admin/system-config")
