...
public class AddWithdrawalCommandHandler(
    ...
    : IRequestHandler<AddWithdrawalCommand, PortfolioDto>
{
    public async Task<PortfolioDto> Handle(AddWithdrawalCommand request, CancellationToken cancellationToken)
    {
        ...
        portfolio.AddWithdrawal(request.Amount, request.Notes);
