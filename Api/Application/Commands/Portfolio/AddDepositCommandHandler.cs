...
public class AddDepositCommandHandler(
    ...
    : IRequestHandler<AddDepositCommand, PortfolioDto>
{
    public async Task<PortfolioDto> Handle(AddDepositCommand request, CancellationToken cancellationToken)
    {
        ...
        portfolio.AddDeposit(request.Amount, request.Notes);
